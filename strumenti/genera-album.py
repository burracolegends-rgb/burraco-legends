...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* 2.55rem era piu' grande di negozio, spacchetta e sala, senza motivo —
     solo disallineamento accumulato. Riportata alla stessa misura di
     selezione.html, che era gia' quella giusta: 1.275rem ovunque. */
