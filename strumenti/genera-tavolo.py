...
BATTLE_CSS = r'''
    ...
    /* LA CARTA IL PIU' GRANDE POSSIBILE — segnalato da chi la apriva sul
       telefono: nota e bottoni impilati SOTTO la carta la costringevano
       piccola, con un sacco di spazio scuro sprecato intorno. Ora nota e
       bottoni sono un velo che poggia SOPRA il bordo inferiore della
       carta (posizionamento assoluto, sfumatura scura dietro per restare
       leggibili), cosi' la carta puo' occupare quasi tutta l'altezza
       disponibile invece di doverci fare spazio sotto di se'. */
    #veloCarta .carta-illustrata {
      height: min(90vh, 640px); width: auto; aspect-ratio: 0.71;
      border-radius: 12px;
    ...
    #veloCarta .controlli {
      ...
      background: linear-gradient(180deg, rgba(6,4,10,0) 0%, rgba(6,4,10,0.82) 45%, rgba(6,4,10,0.94) 100%);
