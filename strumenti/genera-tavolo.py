...
BATTLE_CSS = r'''
    ...
    /* Erano una fascia verde quasi piena (0.92 di opacita') sopra le
       carte, per restare leggibili sullo sfondo fatato — ma il tavolo
       sottostante (pietra, bracieri, il cerchio al centro) spariva
       proprio dove il giocatore guarda di piu': le proprie carte, la
       propria mano. Segnalato da chi lo guardava davvero: "le righe
       dove si trovano le carte sono verdi, vorrei che fossero
       trasparenti". Tolto il colore, tenuto lo sfocato (backdrop-filter)
       che continua a separare otticamente la fascia dallo sfondo dietro
       senza coprirlo con una tinta piatta. */
