...
BATTLE_CSS = r'''
    ...
    /* ============================================================
       ...
       ============================================================ */
    /* La carta jolly aveva solo un gradiente e la scritta "JOLLY" di
       taglio: niente illustrazione, mentre tutto il resto del gioco ne
       ha una. Ora è una faccia vera — la maschera del burlante fra i
       rovi — e tutto il testo che serviva a "arredare" un gradiente
       vuoto (semi, numeri, la scritta di taglio) sparisce: l'immagine
       si spiega da sola, aggiungere lettere sopra la affollerebbe. */
    .card.jolly {
      background: url('immagini/decorazioni/jolly.webp') center / cover no-repeat !important;
    ...
    .card.jolly .banda, .card.jolly .scritta-jolly {
