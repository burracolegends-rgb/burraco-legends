...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .torna { position: fixed; top: 2vh; left: 2vh; z-index: 8; font-size: 2.55rem; color: var(--tenue); text-decoration: none; display: inline-flex; align-items: center; gap: 10px; }
